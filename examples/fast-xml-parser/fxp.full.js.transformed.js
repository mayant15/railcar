(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object") module.exports = factory();else if (typeof define === "function" && define.amd) define([], factory);else if (typeof exports === "object") exports["fxp"] = factory();else root["fxp"] = factory();
})(this, () => {
  return /******/(() => {
    // webpackBootstrap
    /******/
    ...
    var __webpack_modules__ = {
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        consider.hex = true;
        consider.leadingZeros = true;
        consider.decimalPoint = "\.";
        consider.eNotation = true;
        ...
        function getIgnoreAttributesFn(ignoreAttributes) {
          ...
          if (Array.isArray(ignoreAttributes)) {
            return function (attrName) {
              for (var _iterator = _createForOfIteratorHelperLoose(ignoreAttributes), _step; !(_step = _iterator()).done;) {
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        defaultOptions.allowBooleanAttributes = false;
        defaultOptions.unpairedTags = [];
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _orderedJs2Xml_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./orderedJs2Xml.js */"./src/xmlbuilder/orderedJs2Xml.js");
        /* harmony import */
        var _ignoreAttributes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ignoreAttributes.js */"./src/ignoreAttributes.js");
        ...
        defaultOptions.attributeNamePrefix = "@_";
        defaultOptions.attributesGroupName = false;
        defaultOptions.textNodeName = "#text";
        defaultOptions.ignoreAttributes = true;
        defaultOptions.cdataPropName = false;
        defaultOptions.format = false;
        defaultOptions.indentBy = "  ";
        defaultOptions.suppressEmptyNode = false;
        defaultOptions.suppressUnpairedNode = true;
        defaultOptions.suppressBooleanAttributes = true;
        defaultOptions.tagValueProcessor = function tagValueProcessor(key, a) {
          return a;
        };
        defaultOptions.attributeValueProcessor = function attributeValueProcessor(attrName, a) {
          return a;
        };
        defaultOptions.preserveOrder = false;
        defaultOptions.commentPropName = false;
        defaultOptions.unpairedTags = [];
        ...
        defaultOptions.processEntities = true;
        defaultOptions.stopNodes = [];
        defaultOptions.oneListGroup = false;
        function Builder(options) {
          this.options = Object.assign({}, defaultOptions, options);
          if (this.options.ignoreAttributes === true || this.options.attributesGroupName) {
            function ___railcar_anon_func_0___() {
              return false;
            }
            this.isAttribute = ___railcar_anon_func_0___ /*a*/;
          } else {
            this.ignoreAttributesFn = (0, _ignoreAttributes_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.options.ignoreAttributes);
          ...
          if (this.options.format) {
            ...
            function ___railcar_anon_func_1___() {
              return "";
            }
            this.indentate = ___railcar_anon_func_1___;
            this.tagEndChar = ">";
            this.newLine = "";
          }
        }
        function ___railcar_anon_func_2___(jObj) {
          if (this.options.preserveOrder) {
            return (0, _orderedJs2Xml_js__WEBPACK_IMPORTED_MODULE_1__["default"])(jObj, this.options);
          } else {
            if (Array.isArray(jObj) && this.options.arrayNodeName && this.options.arrayNodeName.length > 1) {
              var _jObj;
              jObj = (_jObj = {}, _jObj[this.options.arrayNodeName] = jObj, _jObj);
            }
            return this.j2x(jObj, 0, []).val;
          }
        }
        Builder.prototype.build = ___railcar_anon_func_2___;
        function ___railcar_anon_func_3___(jObj, level, ajPath) {
          var attrStr = "";
          var val = "";
        ...
        Builder.prototype.j2x = ___railcar_anon_func_3___;
        function ___railcar_anon_func_4___(attrName, val) {
        ...
        Builder.prototype.buildAttrPairStr = ___railcar_anon_func_4___;
        ...
        function ___railcar_anon_func_5___(val, key, attrStr, level) {
          if (val === "") {
        ...
        Builder.prototype.buildObjectNode = ___railcar_anon_func_5___;
        function ___railcar_anon_func_6___(key) {
          var closeTag = "";
        ...
        Builder.prototype.closeTag = ___railcar_anon_func_6___;
        ...
        function ___railcar_anon_func_7___(val, key, attrStr, level) {
        ...
        Builder.prototype.buildTextValNode = ___railcar_anon_func_7___;
        function ___railcar_anon_func_8___(textValue) {
        ...
        Builder.prototype.replaceEntitiesValue = ___railcar_anon_func_8___;
        ...
        function arrToStr(arr, options, jPath, indentation) {
          ...
          for (var i = 0; i < arr.length; i++) {
            ...
            if (tagName === options.textNodeName) {
              ...
              xmlStr += tempInd + ("<" + tagName + piTextNodeName + _attStr + "?>");
              isPreviousElementTag = true;
              continue;
            }
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        var DocTypeReader = /*#__PURE__*/(function () {
                ...
                if (xmlData[i] === "<" && !comment) {
                  ...
                  if (hasBody && hasSeq(xmlData, "!ENTITY", i)) {
                    ...
                    if (val.indexOf("&") === -1) //Parameter entities are not supported
                      {
                        entities[entityName] = {};
                        entities[entityName].regx = RegExp("&" + entityName + ";", "g");
                        entities[entityName].val = val;
                      }
          ...
          _proto.readEntityExp = function readEntityExp(xmlData, i) {
          ...
          _proto.readNotationExp = function readNotationExp(xmlData, i) {
            ...
            !this.suppressValidationErr && validateEntityName(notationName); // Skip whitespace after notation name
            ...
            if (identifierType === "PUBLIC") {
              ...
              var _this$readIdentifierV2 = this.readIdentifierVal(xmlData, i, "publicIdentifier");
              ...
              if (xmlData[i] === '"' || xmlData[i] === "'") {
                var _this$readIdentifierV3 = this.readIdentifierVal(xmlData, i, "systemIdentifier");
                i = _this$readIdentifierV3[0];
                systemIdentifier = _this$readIdentifierV3[1];
              }
            } else if (identifierType === "SYSTEM") {
              // Read system identifier (mandatory for SYSTEM)
              var _this$readIdentifierV4 = this.readIdentifierVal(xmlData, i, "systemIdentifier");
          ...
          _proto.readIdentifierVal = function readIdentifierVal(xmlData, i, type) {
            var identifierVal = "";
          ...
          _proto.readElementExp = function readElementExp(xmlData, i) {
            // <!ELEMENT br EMPTY>
            // <!ELEMENT div ANY>
          ...
          _proto.readAttlistExp = function readAttlistExp(xmlData, i) {
            ...
            if (xmlData.substring(i, i + 8).toUpperCase() === "#REQUIRED") {
              ...
              var _this$readIdentifierV5 = this.readIdentifierVal(xmlData, i, "ATTLIST");
        ...
        function validateEntityName(name) {
          if ((0, _util_js__WEBPACK_IMPORTED_MODULE_0__.isName)(name)) return name;else throw new Error("Invalid entity name " + name);
        }
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        defaultOptions.textNodeName = "#text";
        defaultOptions.ignoreAttributes = true;
        defaultOptions.removeNSPrefix = false;
        defaultOptions.allowBooleanAttributes = false;
        defaultOptions.parseTagValue = true;
        defaultOptions.parseAttributeValue = false;
        defaultOptions.trimValues = true;
        defaultOptions.cdataPropName = false;
        defaultOptions.numberParseOptions = {};
        defaultOptions.numberParseOptions.hex = true;
        defaultOptions.numberParseOptions.leadingZeros = true;
        defaultOptions.numberParseOptions.eNotation = true;
        defaultOptions.tagValueProcessor = function tagValueProcessor(tagName, val) {
          return val;
        };
        defaultOptions.attributeValueProcessor = function attributeValueProcessor(attrName, val) {
          return val;
        };
        defaultOptions.stopNodes = [];
        defaultOptions.alwaysCreateTextNode = false;
        defaultOptions.isArray = function isArray() {
          return false;
        };
        defaultOptions.commentPropName = false;
        defaultOptions.unpairedTags = [];
        defaultOptions.processEntities = true;
        defaultOptions.htmlEntities = false;
        defaultOptions.ignoreDeclaration = false;
        defaultOptions.ignorePiTags = false;
        defaultOptions.transformTagName = false;
        defaultOptions.transformAttributeName = false;
        defaultOptions.updateTag = function updateTag(tagName, jPath, attrs) {
          return tagName;
        };
        defaultOptions.captureMetaData = false;
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util.js */"./src/util.js");
        /* harmony import */
        var _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./xmlNode.js */"./src/xmlparser/xmlNode.js");
        /* harmony import */
        var _DocTypeReader_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DocTypeReader.js */"./src/xmlparser/DocTypeReader.js");
        /* harmony import */
        var strnum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! strnum */"./node_modules/strnum/strnum.js");
        /* harmony import */
        ...
        var OrderedObjParser = function OrderedObjParser(options) {
          ...
          this.lastEntities = {};
          this.lastEntities.apos = {};
          this.lastEntities.apos.regex = /&(apos|#39|#x27);/g;
          this.lastEntities.apos.val = "'";
          this.lastEntities.gt = {};
          this.lastEntities.gt.regex = /&(gt|#62|#x3E);/g;
          this.lastEntities.gt.val = ">";
          this.lastEntities.lt = {};
          this.lastEntities.lt.regex = /&(lt|#60|#x3C);/g;
          this.lastEntities.lt.val = "<";
          this.lastEntities.quot = {};
          this.lastEntities.quot.regex = /&(quot|#34|#x22);/g;
          this.lastEntities.quot.val = '"';
          this.ampEntity = {};
          this.ampEntity.regex = /&(amp|#38|#x26);/g;
          this.ampEntity.val = "&";
          this.htmlEntities = {};
          this.htmlEntities.space = {};
          this.htmlEntities.space.regex = /&(nbsp|#160);/g;
          this.htmlEntities.space.val = " ";
          this.htmlEntities.cent = {};
          this.htmlEntities.cent.regex = /&(cent|#162);/g;
          this.htmlEntities.cent.val = "¢";
          this.htmlEntities.pound = {};
          this.htmlEntities.pound.regex = /&(pound|#163);/g;
          this.htmlEntities.pound.val = "£";
          this.htmlEntities.yen = {};
          this.htmlEntities.yen.regex = /&(yen|#165);/g;
          this.htmlEntities.yen.val = "¥";
          this.htmlEntities.euro = {};
          this.htmlEntities.euro.regex = /&(euro|#8364);/g;
          this.htmlEntities.euro.val = "€";
          this.htmlEntities.copyright = {};
          this.htmlEntities.copyright.regex = /&(copy|#169);/g;
          this.htmlEntities.copyright.val = "©";
          this.htmlEntities.reg = {};
          this.htmlEntities.reg.regex = /&(reg|#174);/g;
          this.htmlEntities.reg.val = "®";
          this.htmlEntities.inr = {};
          this.htmlEntities.inr.regex = /&(inr|#8377);/g;
          this.htmlEntities.inr.val = "₹";
          this.htmlEntities.num_dec = {};
          this.htmlEntities.num_dec.regex = /&#([0-9]{1,7});/g;
          this.htmlEntities.num_dec.val = function val(_, str) {
            return String.fromCodePoint(Number.parseInt(str, 10));
          };
          this.htmlEntities.num_hex = {};
          this.htmlEntities.num_hex.regex = /&#x([0-9a-fA-F]{1,6});/g;
          this.htmlEntities.num_hex.val = function val(_, str) {
        ...
        function addExternalEntities(externalEntities) {
          ...
          for (var i = 0; i < entKeys.length; i++) {
            ...
            this.lastEntities[ent].regex = new RegExp("&" + ent + ";", "g");
            this.lastEntities[ent].val = externalEntities[ent];
          }
        } /**
          * @param {string} val
        ...
        function buildAttributesMap(attrStr, jPath) {
          if (this.options.ignoreAttributes !== true && typeof attrStr === "string") {
            ...
            var matches = (0, _util_js__WEBPACK_IMPORTED_MODULE_2__.getAllMatches)(attrStr, attrsRegx);
        ...
        var parseXml = function parseXml(xmlData) {
          ...
          var xmlObj = new _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__["default"]("!xml");
          var currentNode = xmlObj;
          var textData = "";
          var jPath = "";
          var docTypeReader = new _DocTypeReader_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.options.processEntities);
          for (var i = 0; i < xmlData.length; i++) {
            ...
            if (ch === "<") {
              ...
              if (xmlData[i + 1] === "/") {
                ...
                if (this.options.ignoreDeclaration && tagData.tagName === "?xml" || this.options.ignorePiTags) {
                  ...
                  var childNode = new _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__["default"](tagData.tagName);
                ...
                if (this.options.commentPropName) {
                  ...
                  textData = this.saveTextToParentTag(textData, currentNode, jPath);
                  currentNode.add(this.options.commentPropName, [(_ref = {}, _ref[this.options.textNodeName] = comment, _ref)]);
                }
                i = endIndex;
                ...
                if (this.options.cdataPropName) {
                  var _ref2;
                  currentNode.add(this.options.cdataPropName, [(_ref2 = {}, _ref2[this.options.textNodeName] = tagExp, _ref2)]);
                } else {
                ...
                if (this.isItStopNode(this.stopNodesExact, this.stopNodesWildcard, jPath, _tagName)) {
                  ...
                  if (_tagExp.length > 0 && _tagExp.lastIndexOf("/") === _tagExp.length - 1) {
                    ...
                    if (!_result2) throw new Error("Unexpected end of " + rawTagName);
                    i = _result2.i;
                    tagContent = _result2.tagContent;
                  }
                  var _childNode = new _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__["default"](_tagName);
                  ...
                  if (_tagExp.length > 0 && _tagExp.lastIndexOf("/") === _tagExp.length - 1) {
                    ...
                    var _childNode2 = new _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__["default"](_tagName);
                    if (_tagName !== _tagExp && attrExpPresent) {
                    ...
                    var _childNode3 = new _xmlNode_js__WEBPACK_IMPORTED_MODULE_3__["default"](_tagName);
        ...
        function readStopNodeData(xmlData, tagName, i) {
          ...
          for (; i < xmlData.length; i++) {
            if (xmlData[i] === "<") {
              if (xmlData[i + 1] === "/") {
                //close tag
                var closeIndex = findClosingIndex(xmlData, ">", i, tagName + " is not closed");
        ...
        function parseValue(val, shouldParse, options) {
          if (shouldParse && typeof val === "string") {
            //console.log(options)
            var newval = val.trim();
            if (newval === "true") return true;else if (newval === "false") return false;else return (0, strnum__WEBPACK_IMPORTED_MODULE_0__["default"])(val, options);
          } else {
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _OrderedObjParser_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OrderedObjParser.js */"./src/xmlparser/OrderedObjParser.js");
        /* harmony import */
        var _node2json_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node2json.js */"./src/xmlparser/node2json.js");
        /* harmony import */
        var _validator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../validator.js */"./src/validator.js");
        /* harmony import */
        var _xmlNode_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./xmlNode.js */"./src/xmlparser/xmlNode.js");
        var XMLParser = /*#__PURE__*/(function () {
          ...
          _proto.parse = function parse(xmlData, validationOption) {
            ...
            if (validationOption) {
              ...
              var result = (0, _validator_js__WEBPACK_IMPORTED_MODULE_1__.validate)(xmlData, validationOption);
              if (result !== true) {
                throw Error(result.err.msg + ":" + result.err.line + ":" + result.err.col);
              }
            }
            var orderedObjParser = new _OrderedObjParser_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.options);
            orderedObjParser.addExternalEntities(this.externalEntities);
            var orderedResult = orderedObjParser.parseXml(xmlData);
            if (this.options.preserveOrder || orderedResult === undefined) return orderedResult;else return (0, _node2json_js__WEBPACK_IMPORTED_MODULE_3__["default"])(orderedResult, this.options);
          } /**
          ...
          _proto.addEntity = function addEntity(key, value) {
            ...
            */;
          XMLParser.getMetaDataSymbol = function getMetaDataSymbol() {
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _xmlNode_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./xmlNode.js */"./src/xmlparser/xmlNode.js");
      ...
      (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        var XmlNode = /*#__PURE__*/(function () {
          ...
          _proto.add = function add(key, val) {
            ...
            this.child.push((_this$child$push = {}, _this$child$push[key] = val, _this$child$push));
          };
          _proto.addChild = function addChild(node, startIndex) {
            if (node.tagname === "__proto__") node.tagname = "#__proto__";
            if (node[":@"] && Object.keys(node[":@"]).length > 0) {
              var _this$child$push2;
              this.child.push((_this$child$push2 = {}, _this$child$push2[node.tagname] = node.child, _this$child$push2[":@"] = node[":@"], _this$child$push2));
            } else {
              var _this$child$push3;
              this.child.push((_this$child$push3 = {}, _this$child$push3[node.tagname] = node.child, _this$child$push3));
            } // if requested, add the startIndex
            if (startIndex !== undefined) {
              // Note: for now we just overwrite the metadata. If we had more complex metadata,
              // we might need to do an object append here:  metadata = { ...metadata, startIndex }
              this.child[this.child.length - 1][METADATA_SYMBOL] = {};
              this.child[this.child.length - 1][METADATA_SYMBOL].startIndex = startIndex;
            }
          } /** symbol used for metadata */;
          XmlNode.getMetaDataSymbol = function getMetaDataSymbol() {
    ...
    /******/
    (() => {
      function ___railcar_anon_func_9___(exports, definition) {
      ...
      /******/__webpack_require__.d = ___railcar_anon_func_9___;
      /******/
    })();
    /******/
    ...
    /******/
    (() => {
      function ___railcar_anon_func_10___(obj, prop) {
        return Object.prototype.hasOwnProperty.call(obj, prop);
      }
      /******/__webpack_require__.o = ___railcar_anon_func_10___;
      /******/
    })();
    /******/
    ...
    /******/
    (() => {
      function ___railcar_anon_func_11___(exports) {
      ...
      /******/__webpack_require__.r = ___railcar_anon_func_11___;
      /******/
    })();
    /******/
    /************************************************************************/
    ...
    /******/
    XMLValidator.validate = _validator_js__WEBPACK_IMPORTED_MODULE_0__.validate;
