...
var require_encoder = __commonJS({
  "lib/encoder.js"(exports, module) {
    ...
    function JPEGEncoder(quality) {
      ...
      function ___railcar_anon_func_0___(image, quality2) {
      ...
      this.encode = ___railcar_anon_func_0___;
...
var require_decoder = __commonJS({
  "lib/decoder.js"(exports, module) {
    var JpegImage = (function jpegImage() {
      ...
      function decodeScan(data, offset, frame, components, resetInterval, spectralStart, spectralEnd, successivePrev, successive, opts) {
        ...
        function decodeMcu(component2, decode2, mcu2, row, col) {
          ...
          if (component2.blocks[blockRow] === void 0 && opts.tolerantDecoding) return;
      ...
      constructor.prototype.parse = function parse(data) {
          ...
          for (componentId2 in frame2.components) {
            if (frame2.components.hasOwnProperty(componentId2)) {
              ...
              for (var i2 = 0; i2 < blocksPerColumnForMcu; i2++) {
                var row = [];
                for (var j2 = 0; j2 < blocksPerLineForMcu; j2++) row.push(new Int32Array(64));
                blocks.push(row);
              }
          ...
          switch (fileMarker) {
            ...
            case 65534:
              ...
              if (fileMarker === 65504) {
                if (appData[0] === 74 && appData[1] === 70 && appData[2] === 73 && appData[3] === 70 && appData[4] === 0) {
                  jfif = {};
                  jfif.version = {};
                  jfif.version.major = appData[5];
                  jfif.version.minor = appData[6];
                  ...
                  jfif.thumbData = appData.subarray(14, 14 + 3 * appData[12] * appData[13]);
                }
              }
              if (fileMarker === 65505) {
            ...
            case 65474:
              ...
              for (i = 0; i < componentsCount; i++) {
                ...
                frame.components[componentId].h = h;
                frame.components[componentId].v = v;
                frame.components[componentId].quantizationIdx = qId;
                offset += 3;
              }
      ...
      constructor.prototype.getData = function getData(width, height) {
      ...
      constructor.prototype.copyToImageData = function copyToImageData(imageData, formatAsRGBA) {
      ...
      function ___railcar_anon_func_1___(maxMemoryUsageBytes_) {
        totalBytesAllocated = 0;
        maxMemoryUsageBytes = maxMemoryUsageBytes_;
      }
      constructor.resetMaxMemoryUsage = ___railcar_anon_func_1___;
      function ___railcar_anon_func_2___() {
        return totalBytesAllocated;
      }
      constructor.getBytesAllocated = ___railcar_anon_func_2___;
    ...
    function decode(jpegData, userOpts = {}) {
      ...
      defaultOpts.colorTransform = void 0;
      defaultOpts.useTArray = false;
      defaultOpts.formatAsRGBA = true;
      defaultOpts.tolerantDecoding = true;
      defaultOpts.maxResolutionInMP = 100;
      defaultOpts.maxMemoryUsageInMB = 512;
      var opts = {
        ...defaultOpts,
        ...userOpts
      };
      ...
      try {
        ...
        image.exifBuffer = decoder.exifBuffer;
        image.data = opts.useTArray ? new Uint8Array(bytesNeeded) : Buffer.alloc(bytesNeeded);
