...
var S = (s4, o6) => {
  if (e) s4.adoptedStyleSheets = o6.map(t3 => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet);else for (const e3 of o6) {
...
const h = Object.is;
const r2 = Object.defineProperty;
const o2 = Object.getOwnPropertyDescriptor;
const n2 = Object.getOwnPropertyNames;
const a = Object.getOwnPropertySymbols;
const c2 = Object.getPrototypeOf;
var l = globalThis;
...
var g = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
  ...
  static createProperty(t3, s4 = y) {
    if (s4.state && (s4.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t3) && ((s4 = Object.create(s4)).wrapped = true), this.elementProperties.set(t3, s4), !s4.noAccessor) {
      const i4 = /* @__PURE__ */Symbol(),
        e3 = this.getPropertyDescriptor(t3, i4, s4);
      void 0 !== e3 && r2(this.prototype, t3, e3);
    }
  }
  static getPropertyDescriptor(t3, s4, i4) {
    const e3 = (o2(this.prototype, t3) ?? {
      get() {
        return this[s4];
      },
      set(t4) {
  ...
  _$ET(t3, s4) {
    const i4 = this.constructor.elementProperties.get(t3),
      e3 = this.constructor._$Eu(t3, i4);
  ...
  _$AK(t3, s4) {
    ...
    if (void 0 !== e3 && this._$Em !== e3) {
      const t4 = i4.getPropertyOptions(e3),
        h3 = "function" == typeof t4.converter ? {
          fromAttribute: t4.converter
        } : void 0 !== t4.converter?.fromAttribute ? t4.converter : b;
      this._$Em = e3;
...
g.elementStyles = [], g.shadowRootOptions = {
  mode: "open"
}, g[f("elementProperties")] = /* @__PURE__ */new Map(), g[f("finalized")] = /* @__PURE__ */new Map(), u?.({
  ReactiveElement: g
    ...
    for (; null !== (r4 = P.nextNode()) && d3.length < u3;) {
      if (1 === r4.nodeType) {
        if (r4.hasAttributes()) for (const t4 of r4.getAttributeNames()) if (t4.endsWith(h2)) {
          const i5 = v2[a3++],
            s4 = r4.getAttribute(t4).split(o3),
            e4 = /([.?@])?(.*)/.exec(i5);
          d3.push({
            type: 1,
            index: l3,
            name: e4[2],
            strings: s4,
            ctor: "." === e4[1] ? I : "?" === e4[1] ? L : "@" === e4[1] ? z : H
          }), r4.removeAttribute(t4);
        } else t4.startsWith(o3) && (d3.push({
          type: 6,
          index: l3
        }), r4.removeAttribute(t4));
        if (y2.test(r4.tagName)) {
          const t4 = r4.textContent.split(o3),
            i5 = t4.length - 1;
          if (i5 > 0) {
            r4.textContent = s2 ? s2.emptyScript : "";
            for (let s4 = 0; s4 < i5; s4++) r4.append(t4[s4], c3()), P.nextNode(), d3.push({
              type: 2,
              index: ++l3
            });
            r4.append(t4[i5], c3());
      ...
      } else if (8 === r4.nodeType) if (r4.data === n3) d3.push({
        type: 2,
        index: l3
      });else {
        let t4 = -1;
        for (; -1 !== (t4 = r4.data.indexOf(o3, t4 + 1));) d3.push({
          type: 7,
          index: l3
        }), t4 += o3.length - 1;
      }
...
var k = class {
  ...
  u(t3) {
    const el = this._$AD.el;
    const s4 = this._$AD.parts;
    P.currentNode = e3;
    let h3 = P.nextNode(),
      o6 = 0,
      n5 = 0,
...
var R = class _R {
  ...
  $(t3) {
    const i4 = t3.values;
    const s4 = t3._$litType$;
    if (this._$AH?._$AD === e3) this._$AH.p(i4);else {
      const t4 = new k(e3, this),
...
var H = class {
  ...
  _$AI(t3, i4 = this, s4, e3) {
    ...
    let o6 = false;
    if (void 0 === h3) t3 = M(this, t3, i4, 0), o6 = !a2(t3) || t3 !== this._$AH && t3 !== E, o6 && (this._$AH = t3);else {
      const e4 = t3;
      let n5, r4;
...
var z = class extends H {
  ...
  _$AI(t3, i4 = this) {
    ...
    const s4 = this._$AH,
      e3 = t3 === A && s4 !== A || t3.capture !== s4.capture || t3.once !== s4.once || t3.passive !== s4.passive,
      h3 = t3 !== A && (s4 === A || e3);
...
i3._$litElement$ = true, i3["finalized"] = true, s3.litElementHydrateSupport?.({
  LitElement: i3
});
...
var o5 = true;
export { n as CSSResult, i3 as LitElement, g as ReactiveElement, n4 as _$LE, Z as _$LH, S as adoptStyles, i as css, b as defaultConverter, c as getCompatibleStyle, T as html, o5 as isServer, w as mathml, E as noChange, m as notEqual, A as nothing, B as render, e as supportsAdoptingStyleSheets, b2 as svg, r as unsafeCSS };
