...
var require_dom = __commonJS({
  "node_modules/@xmldom/xmldom/lib/dom.js"(exports) {
    ...
    NodeList.prototype.toString = function (isHTML, nodeFilter) {
    ...
    function ___railcar_anon_func_0___(i) {
      _updateLiveList(this);
      return this[i] || null;
    }
    LiveNodeList.prototype.item = ___railcar_anon_func_0___;
    ...
    NamedNodeMap.prototype.item = NodeList.prototype.item;
    NamedNodeMap.prototype.getNamedItem = function (key) {
      var i = this.length;
      while (i--) {
        var attr = this[i];
    ...
    NamedNodeMap.prototype.removeNamedItem = function (key) {
    ...
    CharacterData.prototype.appendData = function (text) {
      text = this.data + text;
      this.nodeValue = this.data = text;
      this.length = text.length;
    };
    CharacterData.prototype.insertData = function (offset, text) {
      this.replaceData(offset, 0, text);
    };
    CharacterData.prototype.appendChild = function (newChild) {
      throw new Error(ExceptionMessage[HIERARCHY_REQUEST_ERR]);
    };
    CharacterData.prototype.deleteData = function (offset, count) {
      this.replaceData(offset, count, "");
    };
    CharacterData.prototype.replaceData = function (offset, count, text) {
    ...
    function ___railcar_anon_func_1___(node, isHtml, nodeFilter) {
      return nodeSerializeToString.call(node, isHtml, nodeFilter);
    }
    XMLSerializer.prototype.serializeToString = ___railcar_anon_func_1___;
...
var require_sax = __commonJS({
  "node_modules/@xmldom/xmldom/lib/sax.js"(exports) {
    ...
    ElementAttributes.prototype.addValue = function (qName, value, offset) {
      if (!tagNamePattern.test(qName)) {
        throw new Error("invalid attribute:" + qName);
      }
      this.attributeNames[qName] = this.length;
      this[this.length++] = {};
      this[this.length++].qName = qName;
      this[this.length++].value = value;
      this[this.length++].offset = offset;
    };
    ElementAttributes.prototype.length = 0;
    ElementAttributes.prototype.getLocalName = function (i) {
      return this[i].localName;
    };
    ElementAttributes.prototype.getLocator = function (i) {
      return this[i].locator;
    };
    ElementAttributes.prototype.getQName = function (i) {
      return this[i].qName;
    };
    ElementAttributes.prototype.getURI = function (i) {
      return this[i].uri;
    };
    ElementAttributes.prototype.getValue = function (i) {
      return this[i].value;
    };
...
var require_dom_parser = __commonJS({
  "node_modules/@xmldom/xmldom/lib/dom-parser.js"(exports) {
    ...
    function ___railcar_anon_func_2___(source, mimeType) {
    ...
    DOMParser.prototype.parseFromString = ___railcar_anon_func_2___;
    ...
    DOMHandler.prototype.characters = function (chars, start, length) {
    ...
    DOMHandler.prototype.comment = function (chars, start, length) {
      chars = _toString.apply(this, arguments);
    ...
    "endDTD,startEntity,endEntity,attributeDecl,elementDecl,externalEntityDecl,internalEntityDecl,resolveEntity,getExternalSubset,notationDecl,unparsedEntityDecl".replace(/\w+/g, function (key) {
      function ___railcar_anon_func_3___() {
        return null;
      }
      DOMHandler.prototype[key] = ___railcar_anon_func_3___;
    });
