/**
 * @xmldom/xmldom uses a weird convention to declare classes that I had trouble supporting in
 * railcar-infer. Instead, just use this declaration file instead where I've turned it into
 * normal classes.
 *
...
declare module '@xmldom/xmldom' {
	...
	class Text extends CharacterData {
		...
		nodeType: Node["TEXT_NODE"] | Node["CDATA_SECTION_NODE"];
		/**
