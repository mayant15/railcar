    ...
    (function () {
      ...
      var runInContext = (function runInContext2(context) {
        ...
        function mixin(object, source, options) {
          ...
          arrayEach(methodNames, function (methodName) {
            ...
            if (isFunc) {
              ...
              object.prototype[methodName] = ___railcar_anon_func_0___;
            }
          });
          return object;
        }
        ...
        arrayEach(["drop", "take"], function (methodName, index) {
          function ___railcar_anon_func_1___(n) {
          ...
          LazyWrapper.prototype[methodName] = ___railcar_anon_func_1___;
          function ___railcar_anon_func_2___(n) {
            return this.reverse()[methodName](n).reverse();
          }
          LazyWrapper.prototype[methodName + "Right"] = ___railcar_anon_func_2___;
        });
        arrayEach(["filter", "map", "takeWhile"], function (methodName, index) {
          var type = index + 1,
            isFilter = type == LAZY_FILTER_FLAG || type == LAZY_WHILE_FLAG;
          function ___railcar_anon_func_3___(iteratee2) {
          ...
          LazyWrapper.prototype[methodName] = ___railcar_anon_func_3___;
        });
        arrayEach(["head", "last"], function (methodName, index) {
          ...
          LazyWrapper.prototype[methodName] = ___railcar_anon_func_4___;
        });
        arrayEach(["initial", "tail"], function (methodName, index) {
          var dropName = "drop" + (index ? "" : "Right");
          function ___railcar_anon_func_5___() {
            return this.__filtered__ ? new LazyWrapper(this) : this[dropName](1);
          }
          LazyWrapper.prototype[methodName] = ___railcar_anon_func_5___;
        });
        function ___railcar_anon_func_6___() {
          return this.filter(identity);
        }
        LazyWrapper.prototype.compact = ___railcar_anon_func_6___;
        function ___railcar_anon_func_7___(predicate) {
          return this.filter(predicate).head();
        }
        LazyWrapper.prototype.find = ___railcar_anon_func_7___;
        function ___railcar_anon_func_8___(predicate) {
          return this.reverse().find(predicate);
        }
        LazyWrapper.prototype.findLast = ___railcar_anon_func_8___;
        ...
        function ___railcar_anon_func_9___(predicate) {
          return this.filter(negate(getIteratee(predicate)));
        }
        LazyWrapper.prototype.reject = ___railcar_anon_func_9___;
        function ___railcar_anon_func_10___(start, end) {
          start = toInteger(start);
          var result2 = this;
        ...
        LazyWrapper.prototype.slice = ___railcar_anon_func_10___;
        function ___railcar_anon_func_11___(predicate) {
          return this.reverse().takeWhile(predicate).reverse();
        }
        LazyWrapper.prototype.takeRightWhile = ___railcar_anon_func_11___;
        function ___railcar_anon_func_12___() {
          return this.take(MAX_ARRAY_LENGTH);
        }
        LazyWrapper.prototype.toArray = ___railcar_anon_func_12___;
        baseForOwn(LazyWrapper.prototype, function (func, methodName) {
          ...
          function ___railcar_anon_func_13___() {
            var value = this.__wrapped__,
          ...
          lodash.prototype[methodName] = ___railcar_anon_func_13___;
        });
        arrayEach(["pop", "push", "shift", "sort", "splice", "unshift"], function (methodName) {
          var func = arrayProto[methodName],
            chainName = /^(?:push|sort|unshift)$/.test(methodName) ? "tap" : "thru",
            retUnwrapped = /^(?:pop|shift)$/.test(methodName);
          function ___railcar_anon_func_14___() {
            var args = arguments;
          ...
          lodash.prototype[methodName] = ___railcar_anon_func_14___;
        });
        baseForOwn(LazyWrapper.prototype, function (func, methodName) {
