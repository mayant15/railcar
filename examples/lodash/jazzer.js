    ...
    try {
        switch (randomCase) {
            case 1:
                ...
                const chunkSize = provider.consumeIntegralInRange(
                    1,
                    input.length,
                );
            ...
            case 9:
                ...
                const start = provider.consumeIntegralInRange(
                    0,
                    array11.length - 1,
                );
                const end = provider.consumeIntegralInRange(
                    start,
                    array11.length - 1,
                );
            ...
            case 10:
                ...
                break;
            case 11:
                const templateString = provider.consumeString(
