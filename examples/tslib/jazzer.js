        ...
        switch (functionName) {
            case "__assign":
                ...
                for (let i = 0; i < numSources; i++) {
                    ...
                    for (let j = 0; j < numProperties; j++) {
                        ...
                        const value = provider.consumeBoolean()
            ...
            case "__rest":
                ...
                const excludedKeys = keys
                    ...
                    .slice(0, provider.consumeIntegral(1, false));
            ...
            case "__spread":
                ...
                for (let i = 0; i < numArrays; i++) {
                    ...
                    for (let j = 0; j < numElements; j++) {
                        const element = provider.consumeBoolean()
                            ? provider.consumeString(10)
                            : provider.consumeNumber();
                        subArr.push(element);
                    }
            ...
            case "__spreadArrays":
                ...
                tslib
                    .__spreadArray([], arr1)
                    .concat(
                        tslib.__spreadArray([], arr2),
                        tslib.__spreadArray([], arr3),
                        tslib.__spreadArray([], arr4),
                        tslib.__spreadArray([], arr5),
                    );
                break;
...
const ignored = ["Class extends value"];
