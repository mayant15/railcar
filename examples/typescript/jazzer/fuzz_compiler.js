...
module.exports.fuzz = function (data) {
    ...
    try {
        ...
        const fileContent = provider.consumeString(
            provider.consumeIntegralInRange(1, 10000),
        );
        ...
        ts.createWatchCompilerHost(
            ...
            ts.sys /* System */,
            ts.createSemanticDiagnosticsBuilderProgram /* createProgram */,
...
function ignoredError(error) {
    return !!ignored.find(
        (message) => error.message.toLowerCase().indexOf(message) !== -1,
    );
}
...
function getWatchFileKind(provider) {
    switch (provider.consumeIntegralInRange(0, 6)) {
        case 0:
            return ts.WatchFileKind.FixedPollingInterval;
        case 1:
            return ts.WatchFileKind.PriorityPollingInterval;
        case 2:
            return ts.WatchFileKind.DynamicPriorityPolling;
        case 3:
            return ts.WatchFileKind.UseFsEvents;
        case 4:
            return ts.WatchFileKind.UseFsEventsOnParentDirectory;
        case 5:
            return ts.WatchFileKind.FixedChunkSizePolling;
        case 6:
            return provider.consumeString(
                provider.consumeIntegralInRange(0, 100),
            );
    }
}
...
function getWatchDirectoryKind(provider) {
    switch (provider.consumeIntegralInRange(0, 4)) {
        case 0:
            return ts.WatchDirectoryKind.UseFsEvents;
        case 1:
            return ts.WatchDirectoryKind.FixedChunkSizePolling;
        case 2:
            return ts.WatchDirectoryKind.DynamicPriorityPolling;
        case 3:
            return ts.WatchDirectoryKind.FixedPollingInterval;
        case 4:
            return provider.consumeString(
                provider.consumeIntegralInRange(0, 100),
            );
...
function getFallbackPollingKind(provider) {
    switch (provider.consumeIntegralInRange(0, 4)) {
        case 0:
            return ts.PollingWatchKind.FixedInterval;
        case 1:
            return ts.PollingWatchKind.PriorityInterval;
        case 2:
            return ts.PollingWatchKind.DynamicPriority;
        case 3:
            return ts.PollingWatchKind.FixedChunkSize;
        case 4:
            return provider.consumeString(
                provider.consumeIntegralInRange(0, 100),
            );
