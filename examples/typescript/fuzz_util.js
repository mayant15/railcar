...
function getCompilerOptions(provider) {
    return {
        ...
        mapRoot: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
        ...
        newLine: provider.consumeBoolean()
        ...
        outFile: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
        paths: {},
        plugins: [],
        ...
        project: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
        reactNamespace: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
        removeComments: provider.consumeBoolean(),
        references: [],
        rootDir: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
        rootDirs: [],
        ...
        sourceRoot: provider.consumeString(
            provider.consumeIntegralInRange(0, 100),
        ),
