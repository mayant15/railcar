/**
 * Runs a cron every 15 seconds that prepares and caches all data.
 */
...
async function updateProjectContainer(
	container: HTMLElement,
	info: ProjectInfo,
	charts: Record<string, Chart>,
) {
	container.querySelector(".mode")!.textContent =
		`Running in ${info.mode} mode.`;
