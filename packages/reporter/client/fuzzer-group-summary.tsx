...
import {
	type GroupedFuzzerInfo,
	type GroupedFuzzerInfoData,
	StatusCode,
} from "../api.ts";
...
export default function FuzzerGroupSummary({
	name,
	data,
}: FuzzerGroupSummaryProps) {
...
function FuzzerStatusLine({
	name,
	status,
	corpus,
	crashes,
}: GroupedFuzzerInfoData) {
	return (
		<div>
			<span>Mode: {name}</span>
			<br />
